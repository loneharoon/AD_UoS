...
# Notes:ANE noisy experiments,for homes 18 and 1 appliance order of 5 and 6 is swaped. 
 ...
 SSHMMS <- c(1.09,0.36,0.68,1.17,0.69,1.81) 
 GSP <- c(4.08,1.32,3.67,2.54,0.80,3.08)
 Appliance <- c(1,2,3,4,5,6)
 Approach <- rep('Noisy',6)
 Result_type <- rep('ANE',6)
 Home <- rep(10,6)
 df_10_ane_noisy <- data.frame(Home,Appliance,Approach,Result_type,CO,FHMM,LBM,SSHMMS,GSP)
 ...
 SSHMMS <- c(1,0.74,1,0.50,0.52,1.03) 
 GSP <- c(15.5,4.48,19.50,1.67,0.77,10.44)
 Appliance <- c(1,2,3,4,5,6)
 Approach <- rep('Noisy',6)
 Result_type <- rep('ANE',6)
 Home <- rep(20,6)
 df_20_ane_noisy <- data.frame(Home,Appliance,Approach,Result_type,CO,FHMM,LBM,SSHMMS,GSP)
 ...
 SSHMMS <- c(1.01,0.21,1.04,1.32,0.95,2.05) 
 GSP <- c(6.51,0.92,2.48,3.45,1.32,3.91)
 Appliance <- c(1,2,3,4,5,6)
 Approach <- rep('Noisy',6)
 Result_type <- rep('ANE',6)
 Home <- rep(16,6)
 df_16_ane_noisy <- data.frame(Home,Appliance,Approach,Result_type,CO,FHMM,LBM,SSHMMS,GSP)
 ...
 SSHMMS <- c(1.04,0.59,0.64,0.46,0.62,1.32) 
 GSP <- c(8.91,3.73,1.12,1.60,1.69,7.04)
 Appliance <- c(1,2,3,4,5,6)
 Approach <- rep('Noisy',6)
 Result_type <- rep('ANE',6)
 Home <- rep(18,6)
 df_18_ane_noisy <- data.frame(Home,Appliance,Approach,Result_type,CO,FHMM,LBM,SSHMMS,GSP)
 ...
 SSHMMS <- c(1.01,1,1.36,1.17,0.59,1) 
 GSP <- c(19.43,9.16,3.66,2.74,1.39,1.33)
 Appliance <- c(1,2,3,4,5,6)
 Approach <- rep('Noisy',6)
 Result_type <- rep('ANE',6)
 Home <- rep(1,6)
 df_1_ane_noisy <- data.frame(Home,Appliance,Approach,Result_type,CO,FHMM,LBM,SSHMMS,GSP)
 ...
 Home <- rep('Frzr_10',3)
 df_10_ad_confusionmat <- data.frame(Home,Result_type,Submetered,CO,FHMM,LBM,SSHMMS,GSP,Metrics)
 ...
 Result_type <- rep('AD_Confusionmetrics',3)
 Home <- rep('Frezr_20',3)
 df_20_ad_confusionmat <- data.frame(Home,Result_type,Submetered,CO,FHMM,LBM,SSHMMS,GSP,Metrics)
 ...
 Result_type <- rep('AD_Confusionmetrics',3)
 Home <- rep('Frezr_16',3)
 df_16_ad_confusionmat <- data.frame(Home,Result_type,Submetered,CO,FHMM,LBM,SSHMMS,GSP,Metrics)
 
 Submetered <- c(1,0.67,0.8)
 CO <- c(0.03,1,0.06)
 FHMM <- c(0,0,0)
 LBM <- c(0.06,0.33,0.1)
 SSHMMS <- c(0.03,1,0.06)
 GSP <- c(0.04,1,0.08)
 ...
 Result_type <- rep('AD_Confusionmetrics',3)
 Home <- rep('Frezr_18',3)
 df_18_ad_confusionmat <- data.frame(Home,Result_type,Submetered,CO,FHMM,LBM,SSHMMS,GSP,Metrics)
 ...
 Result_type <- rep('AD_Confusionmetrics',3)
 Home <- rep('ElecHt_1',3)
 df_1_ad_confusionmat <- data.frame(Home,Result_type,Submetered,CO,FHMM,LBM,SSHMMS,GSP,Metrics)
 
 dff <- rbind(df_10_ad_confusionmat,df_20_ad_confusionmat,
              df_16_ad_confusionmat,df_18_ad_confusionmat,
              df_1_ad_confusionmat)
 keep <- c("Home", "Submetered","CO","FHMM","LBM","SSHMMS","GSP","Metrics")
 df_temp <- dff[keep]
