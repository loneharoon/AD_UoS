...
log_report = True
if log_report:
  logging_file = file_location+"denoisy_resultfile.csv" # denoisy_resultfile.csv
...
disagg_approach = "sshmms" # options are co,fhmm, lbm,sshmms
...
method="denoised/"+ disagg_approach+ "/selected/" # noisy or denoised
